...
% sampling box:
Supperlower = [8e3 3e7 0.5e6; 1e4 4e7 1e6];
...
% first W-HypE:
%%%%%%%%%%%%%%%
filename = ['results/graph_ns4_1_OriginalCosts_WHypE_box_popsize25_randInit.' int2str(generation)];
W = dlmread(filename);
...
mysubplot3sampling(W_nondom, H_nondom, Supperlower, 'W-HypE', 'HypE', 'sample box', title, 'WHypEVsHypE_ns4_1_OriginalCosts.eps');
